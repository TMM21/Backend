...
exports.createBookingSchema = joi_1.default.object().keys({
    ...
    type: joi_1.default
        .string()
        .valid(enums_1.BookingType.ONE_WAY, enums_1.BookingType.ROUND_TRIP)
        .required(),
    ...
    paymentType: joi_1.default
        .string()
        .valid(enums_1.paymentType.POS, enums_1.paymentType.CASH, enums_1.paymentType.CARD)
        .required(),
