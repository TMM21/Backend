...
var StatesService = /** @class */ (function () {
    function StatesService() {
        var _this = this;
        this.createState = function (stateData) { return __awaiter(_this, void 0, void 0, function () {
            var StateRepo, state, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        StateRepo = (0, typeorm_plus_1.getRepository)(stateModel_1.States);
                        state = StateRepo.create(stateData);
                        return [4 /*yield*/, StateRepo.save(state).catch(function (err) {
        ...
        this.getState = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, stateModel_1.States.find()];
                    case 1:
                        state = _a.sent();
                        return [2 /*return*/, state];
                }
